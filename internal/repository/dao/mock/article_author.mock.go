...
//
//	mockgen -source=article_author.go -package=daomocks -destination=./mock/article_author.mock.go
//
...
func (mr *MockArticleAuthorDAOMockRecorder) UpdateById(ctx, art any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
