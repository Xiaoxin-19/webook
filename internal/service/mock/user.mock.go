...
//
//	mockgen -source=user.go -package=svcmocks -destination=./mock/user.mock.go
//
...
// ModifyNoSensitiveInfo mocks base method.
func (m *MockUserService) ModifyNoSensitiveInfo(ctx context.Context, u *domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ModifyNoSensitiveInfo", ctx, u)
	ret0, _ := ret[0].(error)
	return ret0
}

// ModifyNoSensitiveInfo indicates an expected call of ModifyNoSensitiveInfo.
func (mr *MockUserServiceMockRecorder) ModifyNoSensitiveInfo(ctx, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ModifyNoSensitiveInfo", reflect.TypeOf((*MockUserService)(nil).ModifyNoSensitiveInfo), ctx, u)
}

// Profile mocks base method.
func (m *MockUserService) Profile(ctx context.Context, d *domain.User) (*domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Profile", ctx, d)
	ret0, _ := ret[0].(*domain.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserServiceMockRecorder) Profile(ctx, d any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Profile", reflect.TypeOf((*MockUserService)(nil).Profile), ctx, d)
}
